...
gulp.task('watch', function() {
	...
	gulp.watch("app/favicon/**/*").on("all", browserSync.reload);
})
...
function build(done){
	...
	const buildFavicon = gulp.src('app/favicon/**/*')
...
gulp.task('project', gulp.series(clean, 'img', 'sass', 'styles', 'scripts', build));
